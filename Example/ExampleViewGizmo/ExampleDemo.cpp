...
int main(int, char **)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //         its code to learn more about Dear ImGui!). if (show_demo_window)
        ...
        //             ImGui::Begin("DirverCentSystem");                          // Create a window called "Hello,
        //             world!" and append into it.

        //             ImGui::Text("This is some useful text.");               // Display some text (you can use a
        //             format strings too) ImGui::Checkbox("Demo Window", &show_demo_window);      // Edit bools storing
